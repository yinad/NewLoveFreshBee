...
@interface AFBOrderFormController ()
//@property (nonatomic,weak) UITableView *tableView;
@end

@implementation AFBOrderFormController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[AFBOrderFormCell class] forCellReuseIdentifier:cellID];
