...
- (instancetype)initWithImageStrings: (NSArray *)imageStrings andTitles:(NSArray *)titles
{
    ...
    if (self) {
        ...
        for (int i = 0; i < imageStrings.count; i++) {
            ...
            [btn setAttributedTitle:[NSAttributedString ay_imageTextWithImage:[UIImage imageNamed:imageStrings[i]] imageWH:18.0 title:titles[i] fontSize:13 titleColor:[UIColor lightGrayColor] spacing:5] forState:UIControlStateNormal];
