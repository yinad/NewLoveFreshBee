...
- (void)setupUI{
    ...
    [btn_pic setBackgroundImage:[UIImage imageNamed:@"v2_address_edit_normal"] forState:UIControlStateNormal];
    [btn_pic setBackgroundImage:[UIImage imageNamed:@"v2_address_edit_highlighted@2x"] forState:UIControlStateHighlighted];
    ...
    [img_lines mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(btn_pic.mas_left).offset(-20);
    }];
